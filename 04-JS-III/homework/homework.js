...
function dePalabrasAFrase(palabras) {
  ...
  return palabras.join(" "); // metodo "join" devuelve los elementos del arr en forma de string
                             // usando el argumento como separador entre ambos, en este caso " " (espacio)
}
...
function empiezaConNueve(n) {
  ...
  /*
    "variable".toString -> devuelve la variable en forma de texto
    "variable".charAt("posicion") -> devuelve el caracter en la "posicion" de la "variable"
      ej : numero.charAt(0) -> devuelve el primer caracter de la variable numero
  */
